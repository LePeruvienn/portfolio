...
function UsefulLinks () {
	...
	return (
		...
		<div className="w-full flex-grow grid grid-cols-4 grid-rows-3 gap-1">
			...
			>
				<div className="flex flex-col items-center">
					<svg className="px-3" xmlns="http://www.w3.org/2000/svg" fill="white" viewBox="0 0 16 16">
			...
			>
				<div className="flex flex-col items-center">
					<svg xmlns="http://www.w3.org/2000/svg" height="32" width="32" fill="white" viewBox="0 0 16 16">
