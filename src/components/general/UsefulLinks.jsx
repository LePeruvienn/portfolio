	...
	return (
		...
		<div className="w-full text-white flex-grow grid grid-cols-4 grid-rows-3 gap-1">
			...
			>
				<div className="flex flex-col items-center">
					<svg 
						...
						className="h-8 w-8 sm:w-10 sm:h-10 my-2 group-hover:opacity-0 transition-opacity"
					>
					  <path d="M9.293 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V4.707A1 1 0 0 0 13.707 4L10 .293A1 1 0 0 0 9.293 0M9.5 3.5v-2l3 3h-2a1 1 0 0 1-1-1M11 8a3 3 0 1 1-6 0 3 3 0 0 1 6 0m2 5.755V14a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1v-.245S4 12 8 12s5 1.755 5 1.755"/>
					</svg>
					<span className="text-lg font-bold text-center group-hover:opacity-0 transition-opacity">
						{ t ("resume") }
					</span>
					<span className="m-2 absolute opacity-0 translate-y-full group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300 ease-in-out text-center">
			...
			>
				...
				<span className="z-10 text-xl font-bold text-center group-hover:opacity-0 transition-opacity">
					{ t ("myProjects") }
				</span>

				<span className="z-10 m-2 absolute opacity-0 translate-y-full group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300 ease-in-out text-center">
			...
			>
				<div className="flex flex-col items-center">
					...
					<span className="m-2 absolute opacity-0 translate-y-full group-hover:opacity-100 group-hover:translate-y-1/2 transition-all duration-300 ease-in-out text-center">
