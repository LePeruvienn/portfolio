		...
		<div className="w-full text-white flex-grow grid grid-cols-4 grid-rows-3 gap-1">
			...
			>
				<div className="flex flex-col items-center">
					<svg xmlns="http://www.w3.org/2000/svg" fill="white" viewBox="0 0 16 16" className="h-8 w-8 sm:w-10 sm:h-10 my-2">
			...
			>
				<div className="flex flex-col items-center">
					<svg xmlns="http://www.w3.org/2000/svg" fill="white" viewBox="0 0 16 16" className="h-8 w-8 my-1" >
			...
			>
				<div className="flex flex-col items-center">
					<svg xmlns="http://www.w3.org/2000/svg" fill="white" viewBox="0 0 16 16" className="h-8 w-8 my-2">
			...
			>
				<div className="flex flex-col items-center">
					<svg xmlns="http://www.w3.org/2000/svg" fill="white" viewBox="0 0 16 16" className="h-6 w-6 my-2">
